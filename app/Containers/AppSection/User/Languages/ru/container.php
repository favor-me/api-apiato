...
return [
    ...
    'shift_params' => [
        'is_required' => [
            'title' => 'Учитывать смены?',
            'hint' => 'Разрешить создание заказа только при открытой смене.',
        ],
        'fix_rate' => [
            'title' => 'Фикс. ставка смены (руб.)',
            'hint' => 'Фиксированная ставка при открытии смены.',
            'validation' => [
        ...
        'percent_from_order_profit' => [
            ...
            'validation' => [
                'max' => 'Процент прибыли заказа не может быть больше :max.',
