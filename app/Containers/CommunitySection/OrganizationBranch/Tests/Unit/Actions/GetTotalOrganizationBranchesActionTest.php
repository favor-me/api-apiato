...
use App\Containers\CommunitySection\OrganizationBranch\Actions\GetTotalOrganizationBranchesAction;
...
final class GetTotalOrganizationBranchesActionTest extends UnitTestCase
{
    public function test(): void
    {
        ...
        $this->assertTrue(app(GetTotalOrganizationBranchesAction::class)->run() >= $models->count());
    }
}
