...
use App\Containers\CommunitySection\OrganizationBranch\Tasks\UpdateOrganizationBranchTask;
use App\Ship\Parents\Actions\Action;
use App\Ship\Exceptions\UpdateResourceFailedException;

class UpdateOrganizationBranchAction extends Action
{
    /**
    ...
    {
        return app(UpdateOrganizationBranchTask::class)->run($dto);
    }
}
