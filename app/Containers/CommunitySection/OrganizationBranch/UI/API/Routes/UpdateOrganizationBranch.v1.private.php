 ...
 * @apiName updateCommunityOrganizationBranch
 * @api {post} /v1/community/organization-branches/:id Изменить
 ...
 * @apiBody {String} [responsible_by] Ответственный пользователь за отделение.
 *
 * @apiUse OrganizationBranchSuccessSingleResponse
 */

use App\Containers\CommunitySection\OrganizationBranch\Facades\Container;
use App\Containers\CommunitySection\OrganizationBranch\UI\API\Controllers\UpdateOrganizationBranchController;
use Illuminate\Support\Facades\Route;

Route::patch(Container::getApiUri('{' . ID . '}'), UpdateOrganizationBranchController::class)
    ->name('api_community_organization_branch_update_organization_branch')
    ->middleware(['auth:api']);
