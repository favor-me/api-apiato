...
use App\Containers\CommunitySection\Counterparty\Tasks\CreateCounterpartyTask;
use App\Ship\Parents\Actions\Action;
use App\Ship\Exceptions\CreateResourceFailedException;

class CreateCounterpartyAction extends Action
{
    /**
    ...
    {
        return app(CreateCounterpartyTask::class)->run($dto);
    }
}
