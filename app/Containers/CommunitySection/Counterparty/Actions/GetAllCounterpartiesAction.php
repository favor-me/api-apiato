...
use App\Containers\CommunitySection\Counterparty\Tasks\GetAllCounterpartiesTask;
...
class GetAllCounterpartiesAction extends Action
{
    ...
    {
        $task = app(GetAllCounterpartiesTask::class);
