...
use App\Containers\CommunitySection\Counterparty\UI\API\Transformers\CounterpartyToListTransformer;
use App\Ship\Contracts\IsListableRequest;
use App\Ship\Traits\Request\ListableTransformerRequest;

class GetAllCounterpartiesRequest extends CounterpartyApiRequest implements IsListableRequest
{
    ...
    public function getToListTransformer(): CounterpartyToListTransformer
    {
