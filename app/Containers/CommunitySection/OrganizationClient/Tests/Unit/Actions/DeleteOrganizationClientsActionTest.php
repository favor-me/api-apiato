...
final class DeleteOrganizationClientsActionTest extends UnitTestCase
{
    public function testNotTrashed(): void
    {
        $model = OrganizationClientModel::factory()->create();

        $result = app(DeleteOrganizationClientsAction::class)->run([$model->id]);
    ...
    public function testTrashed(): void
    {
        ...
        $result = app(DeleteOrganizationClientsAction::class)->run($ids);
