...
final class RestoreOrganizationUnitsActionTest extends UnitTestCase
{
    public function testNotTrashed(): void
    {
        $model = OrganizationUnitModel::factory()->create();
        $this->assertSame(ZERO, app(RestoreOrganizationUnitsAction::class)->run([$model->id]));
    }
    ...
    public function testTrashed(): void
    {
        ...
        $this->assertSame(1, app(RestoreOrganizationUnitsAction::class)->run([$model->id]));
