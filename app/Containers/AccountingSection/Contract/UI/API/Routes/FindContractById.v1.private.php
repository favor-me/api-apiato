 ...
 * @apiName findByIdAccountingContract

 * @api {get} /v1/accounting/contracts/:id Найти по id
...
use App\Containers\AccountingSection\Contract\UI\API\Controllers\FindContractByIdController;
use Illuminate\Support\Facades\Route;

Route::get(Container::getApiUri('{' . ID . '}'), FindContractByIdController::class)
    ->name('api_accounting_contract_find_by_id_contract')
    ->middleware(['auth:api']);
