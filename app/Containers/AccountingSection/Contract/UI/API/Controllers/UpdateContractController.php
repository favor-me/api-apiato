...
use App\Containers\AccountingSection\Contract\UI\API\Requests\UpdateContractRequest;
use App\Ship\Exceptions\UpdateResourceFailedException;
use App\Ship\Parents\Controllers\ApiController;
use Illuminate\Http\JsonResponse;
use Spatie\DataTransferObject\Exceptions\UnknownProperties;

class UpdateContractController extends ApiController
{
    /**
     * @param UpdateContractRequest $request
     * @param UpdateContractAction $action
     * @return JsonResponse
