...
final class PaidShiftsTest extends ApiTestCase
{
    ...
    {
        parent::setUp();
        $this->endpoint = 'patch@v1/' . Container::getApiUri('paid');
    }
    ...
    public function testSuccess(): void
    {
        ...
        $this->response
            ...
            ->assertJson(
                fn(AssertableJson $json): AssertableJson => $json
                    ->has(MESSAGE)
                    ->where(MESSAGE, Container::transMultiplePaid(1))
                    ->etc()
            );
        ...
        $this->assertInstanceOf(Carbon::class, $shift->payment_at);
    }
}
