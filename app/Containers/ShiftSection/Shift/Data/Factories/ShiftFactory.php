...
namespace App\Containers\ShiftSection\Shift\Data\Factories;
...
final class ShiftFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            CREATED_BY => $user->id,
            Shift::FINISH_AT => Carbon::now()->addHours(8)->format(DATE_TIME_FORMAT),
            Shift::ORGANIZATION_ID => $user->organization_id,
            Shift::ORGANIZATION_BRANCH_ID => $user->organization_branch_id,
            Shift::MONEY => ZERO,
            Shift::START_AT => Carbon::now()->format(DATE_TIME_FORMAT),
