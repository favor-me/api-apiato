...
use App\Containers\OrderSection\Order\UI\API\Transformers\OrderToListTransformer;
use App\Ship\Contracts\IsListableRequest;
use App\Ship\Traits\Request\ListableTransformerRequest;

class GetAllOrdersRequest extends OrderApiRequest implements IsListableRequest
{
    ...
    public function getToListTransformer(): OrderToListTransformer
    {
