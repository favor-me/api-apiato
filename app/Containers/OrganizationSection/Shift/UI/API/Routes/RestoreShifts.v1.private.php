 ...
 * @apiName restoreOrganizationShift
 * @api {post} /v1/restore/organization/shifts Восстановить
...
use App\Containers\OrganizationSection\Shift\UI\API\Controllers\RestoreShiftsController;
use Illuminate\Support\Facades\Route;

Route::post('restore/' . Container::getApiUri(), RestoreShiftsController::class)
    ->name('api_organization_shift_restore_shift')
    ->middleware(['auth:api']);
