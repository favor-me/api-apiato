...
return [
    ...
    'gave_role_permission_info' => 'Предоствили роли «:role» следующие права: «:permission».',
    ...
    'only_hashed_id_allowed' => 'Необходимо передавать только хешированные данные. :field=:value',
    ...
    'unauthorized_action' => 'Это действие несанкционировано.',
